...
public class CustomItemBlockSlab extends ItemBlock
{
	...
	public CustomItemBlockSlab(Block block)
	{
		super(block);
		this.singleSlab = (BlockSlab) MTMBlock.blockSnowBrickSlabSingle;
		this.doubleSlab = (BlockSlab) MTMBlock.blockSnowBrickSlabDouble;
